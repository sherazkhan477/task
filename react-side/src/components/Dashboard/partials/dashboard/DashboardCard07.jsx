...
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center  dark:text-green-500 text-green-900">₹3,877</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center">267</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center dark:text-sky-500 text-sky-700">4.7%</div>
//                 </td>
//               </tr>
//               {/* Row */}
//               <tr>
...
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center  dark:text-green-500 text-green-900">₹3,426</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center">249</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center dark:text-sky-500 text-sky-700">4.4%</div>
//                 </td>
//               </tr>
//               {/* Row */}
//               <tr>
...
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center  dark:text-green-500 text-green-900">₹2,444</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center">224</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center dark:text-sky-500 text-sky-700">4.2%</div>
//                 </td>
//               </tr>
//               {/* Row */}
//               <tr>
...
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center  dark:text-green-500 text-green-900">₹2,236</div>
//                 </td>
//                 <td className="p-2">
...
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center  dark:text-green-500 text-green-900">₹2,034</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center">204</div>
//                 </td>
//                 <td className="p-2">
//                   <div className="text-center dark:text-sky-500 text-sky-700">3.9%</div>
//                 </td>
//               </tr>
//             </tbody>
//           </table>
...
function DashboardCard07() {
  return (
    <div className="col-span-full xl:col-span-8 bg-[#769FCD] dark:bg-[#070F2B] shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Top Channels</h2>
      </header>
      <div className="p-3">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full dark:text-gray-300">
            {/* Table header */}
            <thead className="text-xs uppercase text-gray-400 dark:text-gray-500 bg-[#535C91] dark:bg-gray-700 dark:bg-opacity-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-left">Source</div>
                </th>
            ...
            <tbody className="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    <SiGithub size={30} />
                    <div className="ml-2 text-gray-800 dark:text-gray-100">Github.com</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2.4K</div>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    <FaFacebook size={30}/>
                    <div className="ml-2 text-gray-800 dark:text-gray-100">Facebook</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2.2K</div>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    <GrGoogle size={30}/>
                    <div className="ml-2 text-gray-800 dark:text-gray-100">Google</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2.0K</div>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="ml-2 text-gray-800 dark:text-gray-100">LinkedIn</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2.4K</div>
                ...
                <td className="p-2">
                  <div className="text-center  dark:text-green-500 text-green-900">₹2,536</div>
                </td>
                <td className="p-2">
                  <div className="text-center">240</div>
                </td>
                <td className="p-2">
                  <div className="text-center dark:text-sky-500 text-sky-700">4.6%</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    <SiUpwork size={30}/>
                    <div className="ml-2 text-gray-800 dark:text-gray-100">Upwork.com</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">3.2K</div>
                </td>
                <td className="p-2">
                  <div className="text-center  dark:text-green-500 text-green-900">₹3,236</div>
                </td>
                <td className="p-2">
                  <div className="text-center">320</div>
                </td>
                <td className="p-2">
                  <div className="text-center dark:text-sky-500 text-sky-700">5.2%</div>
                </td>
              </tr>
            </tbody>
          </table>
